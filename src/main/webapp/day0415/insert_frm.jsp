...
$("#btnIdDup").click(function(){
	window.open( "id_dup.jsp", "subWin", "width=402, height=402" );
});
...
<div id="container">
<form action="http://211.63.89.149/jsp_prj/day0415/insert_frm_process.jsp" method="post" id="frm" name="frm"><!--  ///////////////////////////////////////////// -->
<table>
<tr>
...
<td style="width: 300px">
	<input type="text" name="id"  id ="id" class="inputBox" style="width: 240px" readonly="readonly"/> 
	<input type="button" value="중복확인"  id ="btnIdDup" class="btnBorder" /> 
</td> 
</tr>
<tr>
