...
외부 jsp
<div>
<c:import url="jstl_import_b.jsp"></c:import>
<!-- url을 입력받기 때문에 공통 디자인을 사용하는 페이지의 위치가 변경되더라도
공통디자인을 사용하는 문제가 발생하지 않는다., -->
<br>
<c:import url="http://localhost/jsp_prj/day0412/jstl_import_b.jsp"></c:import>
<%-- 변수는 공유되지 않는다. <%=msg %> --%>
