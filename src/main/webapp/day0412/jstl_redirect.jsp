<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <c:redirect url="jstl_vo_foreach.jsp" />
    </c:if>
...
<a href="jstl_redirect.jsp?flag=true">정상적인 요청인 경우</a>
<a href="jstl_redirect.jsp?flag=false">비정상적인 요청인 경우</a>
<br>
<strong>정상적인 경우에 응답될 페이지</strong>
</div>
