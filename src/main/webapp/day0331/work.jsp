...
$("#idChkBtn").click(function(){
	window.open("http://localhost/jsp_prj/day0331/work2.jsp","work2","width=520,height=320,top="
...
<div id="container">
아이디
<input type="text" style="border: 1px solid #333" id="id1"  name="id1" readonly="readonly"/>
<input type="button"  value = "중복 확인" style="border: 1px solid #333" id="idChkBtn" />
</div>
</form>
