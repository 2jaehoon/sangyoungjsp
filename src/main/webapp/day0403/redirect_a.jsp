...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
      info = "정상적인 요청이 있을 때 응답되는 페이지에서  비정상적인 요청이 발생했을 때 응답할 페이지를 설정한 JSP"
    %>
<!DOCTYPE html>
<html>
<head>
...
<%
if( new Random().nextBoolean() ){//비정상적인 요청이 발생한 상황
	 response.sendRedirect("redirect_b.jsp");
// redirect가 될 떄에는 정상 응답을 막는다.
	return;
}//end if
%>
</div>
<h1>정상적인 요청이 있을 때 응답될 내용</h1>
