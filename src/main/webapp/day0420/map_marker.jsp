...
var iwContent = '<div style="padding:5px;">쌍용교육센터! <br><a href="http://sist.co.kr" style="color:blue" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
...
<div id="container">
<div style="width:502px;height:352px; border: 1px solid #333; margin: 0px auto ">
